...
BEGIN
  ...
  PERFORM dblink_connect('cod_a', 'dbname=postgres user=postgres');
  PERFORM dblink_connect('cod_b', 'dbname=postgres user=postgres');
  ...
  PERFORM dblink_connect('cart_a', 'dbname=postgres user=postgres');
  PERFORM dblink_connect('cart_b', 'dbname=postgres user=postgres');
  ...
  PERFORM dblink_connect('adv_a', 'dbname=postgres user=postgres');
  PERFORM dblink_connect('adv_b', 'dbname=postgres user=postgres');
  ...
  RETURNING id INTO v_tx;
  PERFORM dblink_connect('pay_a', 'dbname=postgres user=postgres');
  PERFORM dblink_connect('pay_b', 'dbname=postgres user=postgres');
  ...
  FROM public.orders WHERE id = v_order
  RETURNING id INTO v_tx;
  PERFORM dblink_connect('commit_a', 'dbname=postgres user=postgres');
  PERFORM dblink_connect('commit_b', 'dbname=postgres user=postgres');
