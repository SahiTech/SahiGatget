...
BEGIN
  ...
  PERFORM dblink_connect('cod_a', 'host=127.0.0.1 port=5432 dbname=postgres user=postgres password=postgres');
  PERFORM dblink_connect('cod_b', 'host=127.0.0.1 port=5432 dbname=postgres user=postgres password=postgres');
  ...
  PERFORM dblink_connect('cart_a', 'host=127.0.0.1 port=5432 dbname=postgres user=postgres password=postgres');
  PERFORM dblink_connect('cart_b', 'host=127.0.0.1 port=5432 dbname=postgres user=postgres password=postgres');
  ...
  PERFORM dblink_connect('adv_a', 'host=127.0.0.1 port=5432 dbname=postgres user=postgres password=postgres');
  PERFORM dblink_connect('adv_b', 'host=127.0.0.1 port=5432 dbname=postgres user=postgres password=postgres');
  ...
  RETURNING id INTO v_tx;
  PERFORM dblink_connect('pay_a', 'host=127.0.0.1 port=5432 dbname=postgres user=postgres password=postgres');
  PERFORM dblink_connect('pay_b', 'host=127.0.0.1 port=5432 dbname=postgres user=postgres password=postgres');
  ...
  FROM public.orders WHERE id = v_order
  RETURNING id INTO v_tx;
  PERFORM dblink_connect('commit_a', 'host=127.0.0.1 port=5432 dbname=postgres user=postgres password=postgres');
  PERFORM dblink_connect('commit_b', 'host=127.0.0.1 port=5432 dbname=postgres user=postgres password=postgres');
