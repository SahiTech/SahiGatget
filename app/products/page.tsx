      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm text-center">
          ...
          <p className="mt-2 text-slate-600 max-w-lg mx-auto text-sm">
            The product listing and variant database schemas are prepared for implementation in the upcoming database phase. Official mobile phones and accessories will be listed here.
          </p>
          <div className="mt-6">
            <Button asChild>
