...
export default async function StorefrontLayout({ children }: { children: React.ReactNode }) {
  ...
  return <><SiteHeader />{children}<AssistantButton enabled={assistantConfig.enabled} maintenanceMode={assistantConfig.maintenanceMode} maintenanceMessage={assistantConfig.maintenanceMessage} assistantName={assistantConfig.assistantName} buttonLabel={assistantConfig.buttonLabel} maxVisibleProductCards={assistantConfig.maxVisibleProductCards} showQuickPrompts={assistantConfig.showQuickPrompts} welcomeMessage={assistantConfig.welcomeMessage} quickPrompts={assistantConfig.quickPrompts} /><SiteFooter /></>
}
